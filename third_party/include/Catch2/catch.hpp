...
#if defined(__OBJC__)
// Hack to fix Catch GH issue #1661. Could use id for generic Core support.
// use of const for Core pointers is very uncommon and under ARC it causes some kind of signature mismatch that breaks compilation
template<>
