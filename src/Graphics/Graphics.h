...
namespace Theodore {
  ...
  public:
    ...
    static void DrawArrays(const VertexArray& vao, Primitive mode, unsigned int offset,
                           unsigned int vertices);
    static void DrawElements(const VertexArray& vao, Primitive mode, unsigned int offset,
                             unsigned int count, IndexFormat format);
    static void DrawArraysInstanced(const VertexArray& vao, Primitive mode, unsigned int offset,
                                    unsigned int vertices, unsigned int count);
    static void DrawElementsInstanced(const VertexArray& vao, Primitive mode, unsigned int offset,
    ...
    static void DrawFrustum(const Vector3d& center, float fov, float maxRange, float minRange,
    ...
    static void Line(const Vector3d& start, const Vector3d& end, const Color& color,
                     float thickness = 1.f);
    static void Triangle(const Vector3d& a, const Vector3d& b, const Vector3d& c,
                         const Color& color, float thickness = 1.f);
    static void SolidTriangle(const Vector3d& a, const Vector3d& b, const Vector3d& c,
                              const Color& color);
    static void Circle(const Vector3d& center, float radius, const Color& color,
                       float thickness = 1.f);
    static void Quad(const Vector3d& center, float w, float h, const Color& color,
                     float thickness = 1.f);
    static void SolidQuad(const Vector3d& center, float w, float h, const Color& color);
    static void TexturedQuad(const Vector3d& center, float w, float h, const Vector3d& offset,
                             const Vector3d& scale, const Color& color);
    static void Polygon(const std::vector<Vector3d>& verts, const Color& color,
                        float thickness = 1.f);
