...
namespace Theodore {
  ...
  Quaternion Quaternion::operator+(const float scalar) const { return Quaternion(*this) += scalar; }
  ...
  // Quaternion Quaternion::FromToRotation(const Vector3d& fromDirection, const Vector3d&
  // toDirection) {
  //	vector3df v0 = from;
  //	vector3df v1 = to;
  //	v0.normalize();
